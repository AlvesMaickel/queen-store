        ...
        <div class="card-body">
            ...
            <div class="tag-list">
                {{-- <a class="btn btn-link"
                            style="cursor:default;text-decoration:none;padding:0.187rem 0.37rem;color: rgba(0, 0, 0, 0.55);"
                            href="#"> {{ __('Texto maior 1') }} <i style="cursor:pointer">X</i> </a>
                        <a class="btn btn-link"
                            style="cursor:default;text-decoration:none;padding:0.187rem 0.37rem;color: rgba(0, 0, 0, 0.55);"
                            href="#"> {{ __('Tag 2') }} <i style="cursor:pointer">X</i></a>
                        <a class="btn btn-link"
                            style="cursor:default;text-decoration:none;padding:0.187rem 0.37rem;color: rgba(0, 0, 0, 0.55);"
                            href="#"> {{ __('Tag 3') }} <i style="cursor:pointer">X</i></a>
                        <a class="btn btn-link"
                            style="cursor:default;text-decoration:none;padding:0.187rem 0.37rem;color: rgba(0, 0, 0, 0.55);"
                            href="#"> {{ __('Tag 4') }} <i style="cursor:pointer">X</i></a>
                        <a class="btn btn-link"
                            style="cursor:default;text-decoration:none;padding:0.187rem 0.37rem;color: rgba(0, 0, 0, 0.55);"
                            href="#"> {{ __('Tag 5') }} <i style="cursor:pointer">X</i></a> --}}
            </div>
